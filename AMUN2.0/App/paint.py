...
class SimpleDraw:  
    def __init__(self, master):  
        ...
        self.brush_size = 3  
        self.shape = None  # Initialize shape attribute with None  
        self.last_x, self.last_y = None, None  # Coordinates for drawing lines and shapes  
    ...
    def paint(self, event):  
        if self.shape:  
            return  # Don't paint while drawing a shape  
        if self.eraser_on:  
            paint_color = "white"  
        else:  
